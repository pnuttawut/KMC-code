...
public class FTS2 extends Canvas implements Runnable{
	int size = 128;
	int siteWidth = 3;
	...
	public void run() {
		...
		double Ea9 = 87.0;			//R9....CO* + H* => HCO* + *
		double Ea10 = 51.9;			//R10...HCO* + H* => H2CO* + *
		double Ea11 = 14.6;			//R11i..H2CO* + H* => H3CO* + *
		double Ea12 = 82.7;			//R12...H3CO* + H* => CH3* + OH*
		double Ea13 = 57.6;			//R13...H3CO* + * => CH3* + O*
		double Ea14 = 30.8;			//R14...CH3* + H* => CH4(g) + 2*
		double Ea15 = 54.0;			//R15...CH3* + CO* => CH3CO* + *
		double Ea16 = 52.2;			//R16...CH3CO* + H* => CH3CHO* + *
		double Ea17 = 30.3;			//R17i..CH3CHO* + H* => CH3CH2O* + *
		double Ea18 = 82.9;			//R18...CH3CH2O* + H* => CH3CH2* + OH*
		double Ea19 = 59.4;			//R19...CH3CH2O* + * => CH3CH2* + O*
		double Ea20 = 29.1;			//R20...CH3CH2* + H* => CH3CH3**
		double Ea21 = 42.0;			//R21...CH3CH2* + 2* => CH2CH2** + H*
		double Ea22 = 36.5;			//R22...OH* + H* => H2O* + *
		double Ea23 = 90.9;			//R23...H2O* + * => OH* + H*
		double Ea24 = 94.1;			//R24...OH* + * => O* + H*
		double Ea25 = 63.6;			//R25...O* + H* => OH*
		double Ea26 = 62.2;			//R26...CO* + O* => CO2**
		double Ea27 = 28.5;			//R27...CO2** => CO* + O*
		//Rates constants
		...
		double k10 = A10*Math.exp(-Ea10*1000/(8.314*T));
		double k11 = A11*Math.exp(-Ea11*1000/(8.314*T))*0;
		...
		double k27 = A27*Math.exp(-Ea27*1000/(8.314*T))*0;
		double ktot =k1+k2+k3+k4+k5+k6+k7+k8+k9+k10+k11+k12+k13+k14+k15+k16+k17+k18+k19+k20+k21+k22+k23+k24+k25+k26+k27;
		//Probabilities
		double p1 = k1/ktot;
		double p2 = k2/ktot;
		double p3 = k3/ktot;
		...
		double p26 = k26/ktot;
		double p27 = k27/ktot;
		double ptot=p1+p2+p3+p4+p5+p6+p7+p8+p9+p10+p11+p12+p13+p14+p15+p16+p17+p18+p19+p20+p21+p22+p23+p24+p25+p26+p27;
		//Check!!
		System.out.println("CHECK...,ktot: " + ktot + ", ptot: " + ptot);
		System.out.println("Ea1: "+Ea1 + ", Ea2: "+Ea2 + ", Ea3: "+Ea3 + ", Ea4: "+Ea4 + ", Ea5: "+Ea5 + ", Ea6: "+Ea6 + ", Ea7: "+Ea7 + ", Ea8: "+Ea8 + ", Ea9: "+Ea9 + ", Ea10: "+Ea10 + ", Ea11: "+Ea11 + ", Ea12: "+Ea12 + ", Ea13: "+Ea13 + ", Ea14: "+Ea14 + ", Ea15: "+Ea15 + ", Ea16: "+Ea16 + ", Ea17: "+Ea17 + ", Ea18: "+Ea18 + ", Ea19: "+Ea19 + ", Ea20: "+Ea20 + ", Ea21: "+Ea21 + ", Ea22: "+Ea22 + ", Ea23: "+Ea23 + ", Ea24: "+Ea24 + ", Ea25: "+Ea25 + ", Ea26: "+Ea26 + ", Ea27: "+Ea27);
		System.out.println("k1: "+k1 + ", k2: "+k2 + ", k3: "+k3 + ", k4: "+k4 + ", k5: "+k5 + ", k6: "+k6 + ", k7: "+k7 + ", k8: "+k8 + ", k9: "+k9 + ", k10: "+k10 + ", k11: "+k11 + ", k12: "+k12 + ", k13: "+k13 + ", k14: "+k14 + ", k15: "+k15 + ", k16: "+k16 + ", k17: "+k17 + ", k18: "+k18 + ", k19: "+k19 + ", k20: "+k20 + ", k21: "+k21 + ", k22: "+k22 + ", k23: "+k23 + ", k24: "+k24 + ", k25: "+k25 + ", k26: "+k26 + ", k27: "+k27);
		// Refresh simulation
		if(refresh == true){
		...
		//Running processes
			...
			//instantaneous reaction
				...
				//R10...HCO* + H* => H2CO* + *
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10)){
						if(s[i][j] == 8){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R12...H3CO* + H* => CH3* + OH*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12)){
						if(s[i][j] == 10){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R13...H3CO* + * => CH3* + O*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10+p12)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13)){
						if(s[i][j] == 10){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R14...CH3* + H* => CH4(g) + 2*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14)){
						if(s[i][j] == 13){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R15...CH3* + CO* => CH3CO* + *
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15)){
						if(s[i][j] == 13){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R16...CH3CO* + H* => CH3CHO* + *
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16)){
						if(s[i][j] == 5){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R18...CH3CH2O* + H* => CH3CH2* + OH*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18)){
						if(s[i][j] == 17){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R19...CH3CH2O* + * => CH3CH2* + O*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19)){
						if(s[i][j] == 17){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R20...CH3CH2* + H* => CH3CH3**
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20)){
						if(s[i][j] == 15){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R21...CH3CH2* + 2* => CH2CH2** + H*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20+p21)){
						if(s[i][j] == 15){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R22...OH* + H* => H2O* + *
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20+p21)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20+p21+p22)){
						if(s[i][j] == 11){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R23...H2O* + * => OH* + H*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20+p21+p22)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20+p21+p22+p23)){
						if(s[i][j] == 6){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R24...OH* + * => O* + H*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20+p21+p22+p23)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20+p21+p22+p23+p24)){
						if(s[i][j] == 11){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R25...O* + H* => OH* + *
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20+p21+p22+p23+p24)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20+p21+p22+p23+p24+p25)){
						if(s[i][j] == 14){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R26...CO* + O* => CO2**
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20+p21+p22+p23+p24+p25)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20+p21+p22+p23+p24+p25+p26)){
						if(s[i][j] == 2){
							int c = 0;
							if(s[(i+1)&(size-1)][j] == 14){
					        	c++;
				...
				//R27...CO2** => CO* + O*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20+p21+p22+p23+p24+p25+p26)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p10+p12+p13+p14+p15+p16+p18+p19+p20+p21+p22+p23+p24+p25+p26+p27)){
						if(s[i][j] == 7){
							int c = 0;
							if(s[(i+1)&(size-1)][j] == 7){
					        	c++;
			...
			// Calculate surface coverage
				...
				System.out.println(t+"  "+delt+"   "+Ztot+"  "+Z0+"  "+Z2+"  "+Z3+"  "+Z4+"  "+Z5+"  "+Z6+"  "+Z7+"  "+Z8+"  "+Z9+"  "+Z10+"  "+Z11+"  "+Z12+"  "+Z13+"  "+Z14+"  "+Z15+"  "+Z16+"  "+Z17+"  "+Z18+"  "+Z19+"  "+Z20+"  "+RxCH4+"  "+RxC2H6+"  "+RxC2H4+"  "+RxH2O+"  "+RxCO2+"  "+R19+"  "+R20+"  "+RaCO+"  "+RaH2+"  "+RdCO+"  "+RdH2);
