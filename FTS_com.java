...
public class FTS3 extends Canvas implements Runnable{
	int size = 128;
	int siteWidth = 3;
	...
	Color H2COcolor = new Color(210,105,30);		//chocolate_9---
	...
	Color CH3CHcolor = new Color(244,164,96);		//sandy brown_21
	...
	public void run() {
		...
		double Ea14 = 89.9;			//R14...CO* + H* => HCO* + *
		double Ea15 = 51.9;			//R15...HCO* + H* => H2CO* + *
		double Ea16 = 14.6;			//R16i..H2CO* + H* => H3CO* + *
		double Ea17 = 82.7;			//R17...H3CO* + H* => CH3* + OH*
		double Ea18 = 57.6;			//R18...H3CO* + * => CH3* + O*
		double Ea19 = 5.4;			//R19i..CH3* + CH2* => CH3CH2* + *
		double Ea20 = 54.0;			//R20...CH3* + CO* => CH3CO* + *
		double Ea21 = 52.2;			//R21...CH3CO* + H* => CH3CHO* + *
		double Ea22 = 30.3;			//R22i..CH3CHO* + H* => CH3CH2O* + *
		double Ea23 = 82.9;			//R23...CH3CH2O* + H* => CH3CH2* + OH*
		double Ea24 = 59.4;			//R24...CH3CH2O* + * => CH3CH2* + O*
		double Ea25 = 29.1;			//R25...CH3CH2* + H* => CH3CH3**
		double Ea26 = 42.0;			//R26...CH3CH2* + 2* => CH2CH2** + H*
		double Ea27 = 36.5;			//R27...OH* + H* => H2O* + *
		double Ea28 = 90.9;			//R28...H2O* + * => OH* + H*
		double Ea29 = 57.1;			//R29...OH* + * => O* + H*
		double Ea30 = 63.6;			//R30...O* + H* => OH*
		double Ea31 = 62.2;			//R31...CO* + O* => CO2**
		double Ea32 = 47.7;			//R32...CO2** => CO* + O*
		double Ea33 = 25.0;			//R33...CH3* + CH* => CH3CH* + *
		double Ea34 = 20.8;			//R34...CH3* + CH3* => CH3CH3* + *
		//Rates constants
		...
		double k15 = A15*Math.exp(-Ea15*1000/(8.314*T));
		double k16 = A16*Math.exp(-Ea16*1000/(8.314*T))*0;
		double k17 = A17*Math.exp(-Ea17*1000/(8.314*T));
		double k18 = A18*Math.exp(-Ea18*1000/(8.314*T));
		double k19 = A19*Math.exp(-Ea19*1000/(8.314*T))*0;
		double k20 = A20*Math.exp(-Ea20*1000/(8.314*T));
		double k21 = A21*Math.exp(-Ea21*1000/(8.314*T));
		double k22 = A22*Math.exp(-Ea22*1000/(8.314*T))*0;
		double k23 = A23*Math.exp(-Ea23*1000/(8.314*T));
		double k24 = A24*Math.exp(-Ea24*1000/(8.314*T));
		double k25 = A25*Math.exp(-Ea25*1000/(8.314*T));
		double k26 = A26*Math.exp(-Ea26*1000/(8.314*T));
		double k27 = A27*Math.exp(-Ea27*1000/(8.314*T));
		double k28 = A28*Math.exp(-Ea28*1000/(8.314*T));
		double k29 = A29*Math.exp(-Ea29*1000/(8.314*T));
		double k30 = A30*Math.exp(-Ea30*1000/(8.314*T));
		double k31 = A31*Math.exp(-Ea31*1000/(8.314*T));
		double k32 = A32*Math.exp(-Ea32*1000/(8.314*T))*0;
		double k33 = A33*Math.exp(-Ea33*1000/(8.314*T));
		double k34 = A34*Math.exp(-Ea34*1000/(8.314*T));
		double ktot =k1+k2+k3+k4+k5+k6+k7+k8+k9+k10+k11+k12+k13+k14+k15+k16+k17+k18+k19+k20+k21+k22+k23+k24+k25+k26+k27+k28+k29+k30+k31+k32+k33+k34;
		//Probabilities
		double p1 = k1/ktot;
		double p2 = k2/ktot;
		double p3 = k3/ktot;
		...
		double p33 = k33/ktot;
		double p34 = k34/ktot;
		double ptot=p1+p2+p3+p4+p5+p6+p7+p8+p9+p10+p11+p12+p13+p14+p15+p16+p17+p18+p19+p20+p21+p22+p23+p24+p25+p26+p27+p28+p29+p30+p31+p32+p33+p34;
		//Check!!
		System.out.println("CHECK...,ktot: " + ktot + ", ptot: " + ptot);
		System.out.println("Ea1: "+Ea1 + ", Ea2: "+Ea2 + ", Ea3: "+Ea3 + ", Ea4: "+Ea4 + ", Ea5: "+Ea5 + ", Ea6: "+Ea6 + ", Ea7: "+Ea7 + ", Ea8: "+Ea8 + ", Ea9: "+Ea9 + ", Ea10: "+Ea10 + ", Ea11: "+Ea11 + ", Ea12: "+Ea12 + ", Ea13: "+Ea13 + ", Ea14: "+Ea14 + ", Ea15: "+Ea15 + ", Ea16: "+Ea16 + ", Ea17: "+Ea17 + ", Ea18: "+Ea18 + ", Ea19: "+Ea19 + ", Ea20: "+Ea20 + ", Ea21: "+Ea21 + ", Ea22: "+Ea22 + ", Ea23: "+Ea23 + ", Ea24: "+Ea24 + ", Ea25: "+Ea25 + ", Ea26: "+Ea26 + ", Ea27: "+Ea27 + ", Ea28: "+Ea28 + ", Ea29: "+Ea29 + ", Ea30: "+Ea30 + ", Ea31: "+Ea31 + ", Ea32: "+Ea32 + ", Ea33: "+Ea33 + ", Ea34: "+Ea34);
		System.out.println("k1: "+k1 + ", k2: "+k2 + ", k3: "+k3 + ", k4: "+k4 + ", k5: "+k5 + ", k6: "+k6 + ", k7: "+k7 + ", k8: "+k8 + ", k9: "+k9 + ", k10: "+k10 + ", k11: "+k11 + ", k12: "+k12 + ", k13: "+k13 + ", k14: "+k14 + ", k15: "+k15 + ", k16: "+k16 + ", k17: "+k17 + ", k18: "+k18 + ", k19: "+k19 + ", k20: "+k20 + ", k21: "+k21 + ", k22: "+k22 + ", k23: "+k23 + ", k24: "+k24 + ", k25: "+k25 + ", k26: "+k26 + ", k27: "+k27 + ", k28: "+k28 + ", k29: "+k29 + ", k30: "+k30 + ", k31: "+k31 + ", k32: "+k32 + ", k33: "+k33 + ", k34: "+k34);
		// Refresh simulation
		if(refresh == true){
		...
		//Running processes
			...
			//instantaneous reaction
				...
				//R10i..C* + H* => CH* + *
					if(s[i][j] == 18){
						...
						int c = 0;
				        if(s[(i+1)&(size-1)][j] == 18){
				        	c++;
							ib = (i+1)&(size-1); 
							jb = j;
						}
				        else if(s[(i+1)&(size-1)][(j+1)&(size-1)] == 18){
							c++;
							ib = (i+1)&(size-1); 
							jb = (j+1)&(size-1);
						}
				        else if(s[i][(j+1)&(size-1)] == 18){
							c++;
							ib = i; 
							jb = (j+1)&(size-1);
						}
				        else if(s[(i-1)&(size-1)][j] == 18){
							c++;
							ib = (i-1)&(size-1); 
							jb = j;
						}
				...
				//R22i...CH3CHO* + H* => CH3CH2O* + *
					if(s[i][j] == 16){
						...
						int c = 0;
				        if(s[(i+1)&(size-1)][j] == 16){
				        	c++;
							ib = (i+1)&(size-1); 
							jb = j;
						}
				        else if(s[(i+1)&(size-1)][(j+1)&(size-1)] == 16){
							c++;
							ib = (i+1)&(size-1); 
							jb = (j+1)&(size-1);
						}
				        else if(s[i][(j+1)&(size-1)] == 16){
							c++;
							ib = i; 
							jb = (j+1)&(size-1);
						}
				        else if(s[(i-1)&(size-1)][j] == 16){
							c++;
							ib = (i-1)&(size-1); 
							jb = j;
						}
				...
				//R35i...CH3CH* + H* => CH3CH2* + *
					if(s[i][j] == 21){
						...
						int c = 0;
						if(s[(i+1)&(size-1)][j] == 21){
				        	c++;
							ib = (i+1)&(size-1); 
							jb = j;
						}
				        else if(s[(i+1)&(size-1)][(j+1)&(size-1)] == 21){
							c++;
							ib = (i+1)&(size-1); 
							jb = (j+1)&(size-1);
						}
				        else if(s[i][(j+1)&(size-1)] == 21){
							c++;
							ib = i; 
							jb = (j+1)&(size-1);
						}
				        else if(s[(i-1)&(size-1)][j] == 21){
							c++;
							ib = (i-1)&(size-1); 
							jb = j;
						}
				...
				//R15...HCO* + H* => H2CO* + *
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15)){
						if(s[i][j] == 8){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
					        ...
					        else if(s[(i+1)&(size-1)][(j+1)&(size-1)] == 8){
								c++;
								ib = (i+1)&(size-1); 
								jb = (j+1)&(size-1);
							}
					        else if(s[i][(j+1)&(size-1)] == 8){
								c++;
								ib = i; 
								jb = (j+1)&(size-1);
							}
					        else if(s[(i-1)&(size-1)][j] == 8){
								c++;
								ib = (i-1)&(size-1); 
								jb = j;
							}
				...
				//R17...H3CO* + H* => CH3* + OH*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17)){
						if(s[i][j] == 10){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
							...
							int c = 0;
					        if(s[(i+1)&(size-1)][j] == 10){
					        	c++;
								ib = (i+1)&(size-1); 
								jb = j;
							}
					        else if(s[(i+1)&(size-1)][(j+1)&(size-1)] == 10){
								c++;
								ib = (i+1)&(size-1); 
								jb = (j+1)&(size-1);
							}
					        else if(s[i][(j+1)&(size-1)] == 10){
								c++;
								ib = i; 
								jb = (j+1)&(size-1);
							}
					        else if(s[(i-1)&(size-1)][j] == 10){
								c++;
								ib = (i-1)&(size-1); 
								jb = j;
							}
				...
				//R18...H3CO* + * => CH3* + O*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18)){
						if(s[i][j] == 10){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R20...CH3* + CO* => CH3CO* + *
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20)){
						if(s[i][j] == 13){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R21...CH3CO* + H* => CH3CHO* + *
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21)){
						if(s[i][j] == 5){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
					        ...
					        else if(s[(i+1)&(size-1)][(j+1)&(size-1)] == 5){
								c++;
								ib = (i+1)&(size-1); 
								jb = (j+1)&(size-1);
							}
					        else if(s[i][(j+1)&(size-1)] == 5){
								c++;
								ib = i; 
								jb = (j+1)&(size-1);
							}
					        else if(s[(i-1)&(size-1)][j] == 5){
								c++;
								ib = (i-1)&(size-1); 
								jb = j;
							}
				...
				//R23...CH3CH2O* + H* => CH3CH2* + OH*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23)){
						if(s[i][j] == 17){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
							...
							int c = 0;
							if(s[(i+1)&(size-1)][j] == 17){
					        	c++;
								ib = (i+1)&(size-1); 
								jb = j;
							}
					        else if(s[(i+1)&(size-1)][(j+1)&(size-1)] == 17){
								c++;
								ib = (i+1)&(size-1); 
								jb = (j+1)&(size-1);
							}
					        else if(s[i][(j+1)&(size-1)] == 17){
								c++;
								ib = i; 
								jb = (j+1)&(size-1);
							}
					        else if(s[(i-1)&(size-1)][j] == 17){
								c++;
								ib = (i-1)&(size-1); 
								jb = j;
							}
				...
				//R24...CH3CH2O* + * => CH3CH2* + O*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24)){
						if(s[i][j] == 17){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R25...CH3CH2* + H* => CH3CH3**
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25)){
						if(s[i][j] == 15){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R26...CH3CH2* + 2* => CH2CH2** + H*	
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26)){
						if(s[i][j] == 15){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R27...OH* + H* => H2O* + *
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27)){
						if(s[i][j] == 11){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R28...H2O* + * => OH* + H*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27+p28)){
						if(s[i][j] == 6){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
					        ...
					        random (arr, n);
					        for(int k=0;k<n;k++) {
					        	if((arr[k]==1)&&(s[(i+1)&(size-1)][j] == 6)){
					        		c++;
									ib = (i+1)&(size-1); 
									jb = j;
									break;
								}
					        	else if((arr[k]==2)&&(s[(i+1)&(size-1)][(j+1)&(size-1)] == 6)){
									c++;
									ib = (i+1)&(size-1); 
									jb = (j+1)&(size-1);
									break;
								}
					        	else if((arr[k]==3)&&(s[i][(j+1)&(size-1)] == 6)){
									c++;
									ib = i; 
									jb = (j+1)&(size-1);
									break;
								}
					        	else if((arr[k]==4)&&(s[(i-1)&(size-1)][j] == 6)){
									c++;
									ib = (i-1)&(size-1); 
									jb = j;
									break;
								}
					        	else if((arr[k]==5)&&(s[(i-1)&(size-1)][(j-1)&(size-1)] == 6)){
									c++;
									ib = (i-1)&(size-1); 
									jb = (j-1)&(size-1);
									break;
								}
					        	else if((arr[k]==6)&&(s[i][(j-1)&(size-1)] == 6)){
									c++;
									ib = i; 
									jb = (j-1)&(size-1);
									break;
				...
				//R29...OH* + * => O* + H*
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27+p28)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27+p28+p29)){
						if(s[i][j] == 11){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R30...O* + H* => OH* + *
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27+p28+p29)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27+p28+p29+p30)){
						if(s[i][j] == 14){
							int c = 0;
							int[] arr = {1, 2, 3, 4, 5, 6};
					        int n = arr.length;
				...
				//R31...CO* + O* => CO2**
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27+p28+p29+p30)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27+p28+p29+p30+p31)){
						if(s[i][j] == 2){
							int c = 0;
				...
				//R32...CO2** => CO* + O*	
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27+p28+p29+p30+p31)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27+p28+p29+p30+p31+p32)){
						if(s[i][j] == 7){
							int c = 0;
							if(s[(i+1)&(size-1)][j] == 7){
					        	c++;
				...
				//R33...CH3* + CH* => CH3CH* + *
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27+p28+p29+p30+p31+p32)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27+p28+p29+p30+p31+p32+p33)){
						if(s[i][j] == 13){
							int c = 0;
					        if(s[(i+1)&(size-1)][j] == 19){
					        	c++;
				...
				//R34...CH3* + CH3* => CH3CH3* + *
					else if((p>=p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27+p28+p29+p30+p31+p32+p33)&&(p<p1+p2+p3+p4+p5+p6+p7+p9+p11+p12+p13+p14+p15+p17+p18+p20+p21+p23+p24+p25+p26+p27+p28+p29+p30+p31+p32+p33+p34)){
						if(s[i][j] == 13){
							int c = 0;
					        if(s[(i+1)&(size-1)][j] == 13){
					        	c++;
			...
			// Calculate surface coverage
				...
				Z20 = (double)z20/(L*L);
				Z21 = (double)z21/(L*L);
				double Ztot = Z0+Z2+Z3+Z4+Z5+Z6+Z7+Z8+Z9+Z10+Z11+Z12+Z13+Z14+Z15+Z16+Z17+Z18+Z19+Z20+Z21;
			...
			// Calculate rate
				...
				System.out.println(t+"  "+delt+"   "+Ztot+"  "+Z0+"  "+Z2+"  "+Z3+"  "+Z4+"  "+Z5+"  "+Z6+"  "+Z7+"  "+Z8+"  "+Z9+"  "+Z10+"  "+Z11+"  "+Z12+"  "+Z13+"  "+Z14+"  "+Z15+"  "+Z16+"  "+Z17+"  "+Z18+"  "+Z19+"  "+Z20+"  "+Z21+"  "+RxCH4+"  "+RxC2H6+"  "+RxC2H4+"  "+RxH2O+"  "+RxCO2+"  "+R19+"  "+R20+"  "+R33+"  "+R34+"  "+RaCO+"  "+RaH2+"  "+RdCO+"  "+RdH2);
	...
	void colorSquare(int i, int j){
		...
		else if(s[i][j] == 9) offScreenGraphics.setColor(H2COcolor);
		...
		else if(s[i][j] == 21) offScreenGraphics.setColor(CH3CHcolor);
		if(j%2==1) {
